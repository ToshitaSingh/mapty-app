...
// const run1 = new Running([23.45, 12.66], 5.2, 24, 178);
// const cycle1 = new Cycling([23.45, 12.66], 27, 95, 523);
...
class App {
  ...
  _loadMap(position) {
    ...
    // render workout from local storage on map
  ...
  _newWorkout(e) {
    // Helper function checks - data validation
